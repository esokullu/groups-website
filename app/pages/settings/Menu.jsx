        ...
        return (
            <div className="menu container">
                ...
                ? <div key={key} className="switcher">
                    <a id={'toggle-' + item.family.replace(/[:.]/g,'-')} className="toggle" onClick={() => this.toggleCluster(item.family.replace(/[:.]/g,'-'))} data-label={item.groupsTitle} data-family={item.family.replace(/[:.]/g,'-')}>
                        {(item.groupsTitle.length > 17) ? (item.groupsTitle.substring(0, 15) + "...") : item.groupsTitle}
